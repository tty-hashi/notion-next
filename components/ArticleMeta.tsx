...
const ArticleMeta: React.FC<ArticleProps> = ({ page }) => {
  return (
    <>
      {" "}
      {/* page cover */}
      <Image className="w-full max-w-screen-lg rounded-lg aspect-video my-4" src={getCover(page.cover)} alt="" objectFit="cover" width={640} height={360} quality={50} />
      {/* page name */}
